...
<html>
   ...
   displayBlock.append("<div class='sticky'><div class='candidate'>VOTE FOR CHANGE</div><br>");
             if(c==null)
             {
                displayBlock.append("<div class='subcandidate'>Sorry Your could'nt be Casted</div><br><br>");
             ...
             {    
                ...
                displayBlock.append("<div><h4 id='logout'><a href='login.html'>Logout</a></h4></div>");
                 out.println(displayBlock);             
             }
            %>
